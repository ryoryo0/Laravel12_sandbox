<x-admin.app-layout>
  ...
  <nav class="flex mb-6" style="justify-content: flex-end" aria-label="Breadcrumb">
    ...
    <form class="mx-auto" method="POST" action="{{ route('admin.product.update', $product->id) }}">
      @csrf
      @method('PUT')
      <div class="mb-4">
      ...
      <div class="flex mt-6 mb-6">
        @foreach ($categories as $key => $value)
          <div class="flex items-center me-4">
              <input id="{{ $value }}" @checked(
                  is_array(old('category_ids'))
                  ? in_array($key, old('category_ids'))
                  : (isset($product) && $product->categories->contains('id', $key))
              ) type="checkbox" name="category_ids[]" value="{{ $key }}" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded-sm focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:border-gray-600">
      ...
      <div class="flex mt-6 mb-6">
        <div class="flex items-center me-4">
            <input id="public_true" type="radio" @checked(old('is_public', $product->is_public ?? '0') == '1')  value="1" name="is_public" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:border-gray-600">
            <label for="public_true" class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-900">公開</label>
        </div>
        <div class="flex items-center me-4">
            <input id="public_false" type="radio" @checked(old('is_public', $product->is_public ?? '0') == '0')  value="0" name="is_public" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:border-gray-600">
      ...
      <div class="flex items-center">
          ...
          <input id="is_pick_up" type="checkbox" value="1" name="is_pick_up" @checked(old('is_pick_up', $product->is_pick_up ?? false)) class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded-sm focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:border-gray-600">
